<div class="modal fade" id="modalResetPassword" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        ...
        <form action="" method="GET" enctype="multipart/form-data" id="form-reset-password">
          <div class="modal-body">
            Anda yakin ingin mereset password akun ini?<br>
            Nama: <span id="nama1"></span><br>
            NIP: <span id="nip1"></span><br>
          </div>
